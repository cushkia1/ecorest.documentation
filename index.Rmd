...
Table1[4,] <- c("4. Articulate relationships among model components.", "Components interact through a modular workflow in which model inputs are used to build suitability relationships, index-model functions compute habitat outputs, and decision-support functions consume those outputs to evaluate trade-offs.")
